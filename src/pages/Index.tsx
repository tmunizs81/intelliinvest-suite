...
const defaultLayouts: any = {
  lg: [
    ...
    { i: 'simulator', x: 0, y: 43, w: 6, h: 9, minW: 4, minH: 6 },
  ...
  md: [
    ...
    { i: 'simulator', x: 0, y: 55, w: 5, h: 9, minW: 4, minH: 6 },
    { i: 'goals', x: 5, y: 55, w: 5, h: 9, minW: 4, minH: 6 },
    { i: 'news', x: 0, y: 64, w: 6, h: 7, minW: 4, minH: 5 },
  ...
  sm: [
    ...
    { i: 'rebalance', x: 0, y: 26, w: 6, h: 7, minW: 6, minH: 5 },
